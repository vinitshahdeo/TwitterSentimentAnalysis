...
<head>
    ...
    <link rel="shortcut icon" href="./twitter-logo.ico" type="image/x-icon">
    ...
    ?>
        ...
        <div class="aa_htmlTable">
            <table class="table" border="1">
                <tr class="title" style="font-size: 1.5rem;background-color:pink">
                    <th>USER</th>
                    <th>TWEET</th>
                    <th>LINK</th>
                    <th>SENTIMENT</th>
        ...
        </div><i class="fa fa-code" aria-hidden="true"></i> with <i class="fa fa-heart" aria-hidden="true"></i> by <strong>Vinit Shahdeo</strong>
    <?php
    }
